...
def read_options(num_users=5, loc_ep=10, Numb_Glob_Iters=100, lamb=0, learning_rate=0.01, alg='fedprox', weight=True, batch_size = 0):
...
def main(num_users=5, loc_ep=10, Numb_Glob_Iters=100, lamb=0, learning_rate=0.01, alg='fedprox', weight=True, batch_size = 0):
    # suppress tf warnings
    tf.logging.set_verbosity(tf.logging.WARN)

    # parse command line arguments
    options, learner, optimizer = read_options(
        num_users, loc_ep, Numb_Glob_Iters, lamb, learning_rate, alg, weight, batch_size)
...
def plot_summary_2(num_users=100, loc_ep1=5, Numb_Glob_Iters=10, lamb=[], learning_rate=[], algorithms_list=[], batch_size=0):
...
def plot_summary(num_users=100, loc_ep1=[], Numb_Glob_Iters=10, lamb=[], learning_rate=[], algorithms_list=[], batch_size = 0):
...
if __name__ == '__main__':
    ...
    if(0):
        ...
        for i in range(len(algorithms_list)):
            main(num_users=10, loc_ep=local_ep[i], Numb_Glob_Iters=100, lamb=lamb_value[i],
                 learning_rate=learning_rate[i], alg=algorithms_list[i], batch_size=batch_size)

        plot_summary_2(num_users=10, loc_ep1=local_ep, Numb_Glob_Iters=100, lamb=lamb_value,
                       learning_rate=learning_rate, algorithms_list=algorithms_list, batch_size=batch_size)
