...
def read_options(num_users=5, loc_ep=10, Numb_Glob_Iters=100, lamb=0, learning_rate=0.01, alg='fedprox', weight=True):
    ...
    parser.add_argument('--model',
                        help='name of model;',
                        type=str,
                        default='stacked_lstm.py')  # 'stacked_lstm.py'
    ...
    import flearn.models.shakespeare.stacked_lstm as mclr
    mod = mclr
...
if __name__ == '__main__':
    ...
    if(0):
        ...
        for i in range(len(algorithms_list)):
            main(num_users=10, loc_ep=local_ep[i], Numb_Glob_Iters=200,
                 lamb=lamb_value[i], learning_rate=learning_rate[i], alg=algorithms_list[i])

        plot_summary(num_users=10, loc_ep1=local_ep, Numb_Glob_Iters=200, lamb=lamb_value,
